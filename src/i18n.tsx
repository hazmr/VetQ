...
const ar: Dict = {
  ...
  'login.submit': 'دخول',
  'login.chooseUser': 'اختر المستخدم',
  'login.signingIn': 'جارٍ الدخول…',
  'login.passwordFor': 'كلمة مرور {name}',
  // counter
  ...
  'settings.paper80': '80 مم',
  'settings.paper58': '58 مم',
  'settings.paperCustom': 'مخصص',
  'settings.paperWidthMm': 'العرض (مم)',
...
const en: Dict = {
  ...
  'settings.paper80': '80 mm',
  'settings.paper58': '58 mm',
  'settings.paperCustom': 'Custom',
  'settings.paperWidthMm': 'Width (mm)',
